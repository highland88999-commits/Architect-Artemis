module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`[https://generativelanguage.googleapis.com/v1beta/models/gemini-3.8-flash:generateContent?key=$](https://generativelanguage.googleapis.com/v1beta/models/gemini-3.8-flash:generateContent?key=$){process.env.GEMINI_API_KEY}`, {
      method: 'POST',
